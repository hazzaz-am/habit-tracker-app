...
export default function StreaksScreen() {
	...
	const badgeStyles = [styles.badge1, styles.badge2, styles.badge2];
					...
					{rankedHabits.slice(0, 3).map((item, key) => (
						<View key={key} style={styles.rankingRow}>
							<View style={[styles.rankingBadge, badgeStyles[key]]}>
								<Text style={styles.rankingNumber}>{key + 1}</Text>
							</View>
							...
							<Card.Content>
								...
								<View style={styles.stats}>
									<View style={styles.statBadge}>
										<Text style={styles.statBadgeTitle}>🔥 {streak}</Text>
										<Text style={styles.statBadgeLabel}>Current</Text>
									</View>
									<View style={styles.statBadgeGold}>
										<Text style={styles.statBadgeTitle}>🏆 {bestStreak}</Text>
										<Text style={styles.statBadgeLabel}>Best</Text>
									</View>
									<View style={styles.statBadgeGreen}>
										<Text style={styles.statBadgeTitle}>✅ {total}</Text>
